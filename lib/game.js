...
var Game = function () {
  ...
  this.elements.push(this.start_button);
  this.elements.push(this.restart_button);
  this.elements.push(this.mute_button);
...
Game.prototype.drawStartScreen = function (ctx) {
  ...
  // ctx.fillRect(0, 0, window.innerWidth, Game.DIM_Y);
  {
    ...
    // });
      // context.fillStyle = this.elements[0].color;
      context.fillStyle = this.start_button.color;

      context.fillRect(((window.innerWidth / 2) - this.start_button.width - 10), this.start_button.top, this.start_button.width, this.start_button.height);

      // context.fillRect((window.innerWidth / 2) - 135, this.elements[0].top, this.elements[0].width, this.elements[0].height);

      context.fillStyle = this.mute_button.color;
      context.fillRect(((window.innerWidth / 2) + 10), this.mute_button.top, this.mute_button.width, this.mute_button.height);
    // -------------------
    ...
    ctx.font = "48px Kaushan Script";
      ...
      ctx.fillText("- Press E to show your might! (WARNING! SOUND!)", (window.innerWidth / 2) - 255, 485);
...
Game.prototype.drawEndScreen = function (ctx) {
  ...
  // ctx.fillRect(0, 0, Game.DIM_X, Game.DIM_Y);
  {
      ...
      // context.fillStyle = this.elements[1].color;
      context.fillStyle = this.restart_button.color;

      context.fillRect((window.innerWidth / 2) - 200, this.restart_button.top, this.restart_button.width, this.restart_button.height);
