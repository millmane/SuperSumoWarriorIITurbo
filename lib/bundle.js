...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      if (this.started === true){
	        if (this.gameTime < 180) {
	          ...
	          ctx.fillStyle = "#0a7e8c";
	            ctx.font = "normal normal 72px Herculanum";
	            ctx.fillText(3 - Math.floor(this.gameTime/60), (window.innerWidth / 2), window.innerHeight / 2);
	
	            ctx.font = "normal normal 48px Herculanum";
	            ctx.fillText("Directions", 25, 50);
	            ctx.font = "normal normal 24px Herculanum";
	            ctx.fillText("_______________________", 15, 52);
	            ctx.fillText("- W,A,S,D to move", 32, 80);
	            ctx.fillText("- Stay within the ring", 32, 110);
	            ctx.fillText("- Press Space Bar to show your might!", 32, 140);
	          ...
	          ctx.fillStyle = "#0a7e8c";
	            ctx.font = "normal normal 48px Herculanum";
	            ctx.fillText("Score: " + Math.floor(this.gameTime), (window.innerWidth / 2) - 100, 100);
	...
	Game.prototype.drawStartScreen = function (ctx) {
	  ...
	  // ctx.fillRect(0, 0, Game.DIM_X, Game.DIM_Y);
	  {
	    ...
	    // });
	      ...
	      context.fillRect(this.elements[0].left, this.elements[0].top, this.elements[0].width, this.elements[0].height);
	    // -------------------
	
			ctx.fillStyle = "#0a7e8c";
		  	ctx.font = "normal normal 60px Herculanum";
		  	ctx.fillText("SUPER SUMO WARRIOR II TURBO", (window.innerWidth / 2) - 450, 125);
	
	      ctx.font = "normal normal 36px Herculanum";
		  	ctx.fillText("Enter the ring and TEST YOUR MIGHT!", (window.innerWidth / 2) - 370, 180);
	
	      ctx.font = "normal normal 48px Herculanum";
	      ctx.fillText("Directions", (window.innerWidth / 2) - 135, 370);
	      ctx.font = "normal normal 24px Herculanum";
	      ctx.fillText("_______________________", (window.innerWidth / 2) - 145, 372);
	      ctx.fillText("- W,A,S,D to move", (window.innerWidth / 2) - 110, 400);
	      ctx.fillText("- Stay within the ring", (window.innerWidth / 2) - 140, 430);
	      ctx.fillText("- Space Bar to show your might!", (window.innerWidth / 2) - 200, 460);
		  	// ctx.fillText("TEST YOUR MIGHT!", (window.innerWidth / 2) - 460, 225);
	      ctx.fillStyle = "#cd7f7f";
	      ctx.font = "normal normal 36px Herculanum";
	
		  	ctx.fillText("Click to start", (window.innerWidth / 2) - 140, 280);
	...
	Game.prototype.drawEndScreen = function (ctx) {
	  ...
	  // ctx.fillRect(0, 0, Game.DIM_X, Game.DIM_Y);
	  {
	      ...
	      context.fillRect(this.elements[1].left, this.elements[1].top, this.elements[1].width, this.elements[1].height);
	
	      ctx.fillStyle = "#0a7e8c";
	        ctx.font = "normal normal 48px Herculanum";
	        ctx.fillText("YOU HAVE FALLEN, BUT WITH HONOR.", (window.innerWidth / 2) - 470, 125);
	
	        ctx.fillText("High Score: " + Math.floor(this.highScore), (window.innerWidth / 2) - 210, 200);
	
	
	
	        ctx.fillStyle = "#cd7f7f";
	        ctx.font = "normal normal 36px Herculanum";
	        ctx.fillText("Click to Restart", (window.innerWidth / 2) - 175, 285);
