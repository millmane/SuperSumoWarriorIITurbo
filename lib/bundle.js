	...
	Game.prototype.drawStartScreen = function (ctx) {
	  this.elements = [this.start_button, this.mute_button];
	    ...
	    ctx.fillStyle = this.mute_button.color;
	      ...
	      ctx.fillText("- Press E to show your might!", (window.innerWidth / 2) - 185, 485);
	      ctx.fillText("- Press F to become immovable!", (window.innerWidth / 2) - 185, 515);
	      ctx.fillText("- Press R to knock your enemies into the air!", (window.innerWidth / 2) - 185, 545);
